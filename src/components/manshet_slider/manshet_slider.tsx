...
const Manshet_slider = ({ data = [] }: { data: SlideItem[] }) => {
    const settings = {
        dots: true,
        arrows: true,
        infinite: true,
                    ...
                    {data.map((item, idx) => (
                        <div className={styles.item} key={idx}>
                            <a href="#">
                                ...
                                <div
                                    className={`${styles.featured_category} ${OverpassMedium.className}`}
                                >
